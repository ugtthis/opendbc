...
import json
import os
from opendbc.car.docs import get_car_docs_with_extras
...
def car_docs_to_dict(c: CarDocs | ExtraCarDocs) -> dict:
    """
...
def main():
    # Retrieve a list of all known cars including extras from docs.py
    ...
    output_filename = "all_cars_with_extras.json"
    # Write out to file
    with open(output_filename, 'w') as f:
        json.dump(cars_data, f, indent=2)
    print(f"Generated JSON with all known cars (including extras) in: {os.path.abspath(output_filename)}")
